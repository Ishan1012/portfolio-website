...
import certifications from '@/hooks/CertificationHook';
                        ...
                        {certifications.map((certification, index) => (
                            ...
                            >
                                <div className="border border-neutral-800 rounded-lg p-6 h-full flex flex-col">
                                    <Link href={certification.link} target='_blank' className="border border-neutral-900 mx-2 my-2 mb-8 rounded-md">
                                        <Image src={certification.img} width={500} height={250} alt={certification.title} className='w-full h-auto rounded-md' />
                                    </Link>
                                    ...
                                    <div className="flex flex-wrap gap-2 mb-4">
                                        <span className="bg-neutral-800 text-xs px-2 py-1 rounded">
